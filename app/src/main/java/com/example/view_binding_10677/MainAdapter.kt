package com.example.view_binding_10677

import android.view.LayoutInflater
import android.view.ViewGroup
import com.example.view_binding_10677.databinding.RecyclerviewItemBinding
...
class MainAdapter(val taskList: List<Task>) : RecyclerView.Adapter<MainAdapter.MainViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, vieType: Int): MainViewHolder{
